...
namespace Utilities
{
    public class RandomSpawnTarget : MonoBehaviour
    {
        ...
        {
            lastTarget = Instantiate(target,
                new Vector3(Random.Range(minBounds.x, maxBounds.x), Random.Range(minBounds.y, maxBounds.y),
                    Random.Range(minBounds.z, maxBounds.z)), Quaternion.identity);
